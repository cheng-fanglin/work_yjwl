...
@Entity
@Table(name = "tbsh35a")
public class Tbsh35a implements Serializable {
	...
	public Tbsh35a(String sh35aId, String sh35Id, String compId,
	...
	public void setSh35aId(String sh35aId) {
		this.sh35aId = sh35aId;
	}

	@Id
	@Column(name = "SH35A_ID_", length = 50, nullable = false)
	public String getSh35aId() {
		return sh35aId;
	}
	...
	public String toString() {
		return "Tbsh35a [sh35aId=" + sh35aId + ",sh35Id=" + sh35Id + ",compId="
				+ compId + ",compCode=" + compCode + ",settleNo=" + settleNo
				+ ",transNo=" + transNo + ",shipListNo=" + shipListNo + ",hc="
				+ hc + ",shipNo=" + shipNo + ",phoneNo=" + phoneNo
				...
				+ ",backShipWgt=" + backShipWgt + ",startDock=" + startDock
				+ ",endDock=" + endDock + ",apUnitPrice=" + apUnitPrice
				+ ",arActMount=" + arActMount + ",lgr=" + lgr + ",qsr=" + qsr
				+ ",zdr=" + zdr + ",lb=" + lb + ",status=" + status
