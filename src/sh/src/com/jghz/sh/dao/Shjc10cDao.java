...
/**
 * 
 * 项目名称：jghz 类名称：Shjc10cDao 类描述： 创建人：Tom 创建时间：1026-10-29 下午2:20:09 修改人：Tom
 ...
 */
@Repository
public class Shjc10cDao extends BaseDao {
	 ...
	 * @throws Exception
	 */
	public void pagingQuery(Page<Tbsh10c> page, Map<String, Object> paramater)
			throws Exception {
		StringBuffer sqlStr = new StringBuffer();
		sqlStr.append(" from Tbsh10c where 1=1 ");
		if (paramater != null) {
