...
*/
@Repository
public class Shjc32aDao extends BaseDao {
	 ...
	 * @throws Exception
	 */
	public void pagingQuery(Page<Tbsh32a> page, Map<String, Object> paramater)
			throws Exception {
		 StringBuffer sqlStr = new StringBuffer();
		 sqlStr.append(" from Tbsh32a where 1=1 ");
		 if(paramater!= null){
		...
		if(CollectionUtils.isEmpty(list)){
			...
			sqlStr.append(" from Tbsh10 where 1=1 ");
			 if(paramater!= null){
				 String transNo = AppUtils.toValidString(paramater.get("transNo"));
...
//		super.pagingQuery(page, sqlStr.toString(), "select count(*) " + sqlStr.toString());
	...
	public List querySh32aBySettleNo(String settleNo){
		StringBuffer sqlStr = new StringBuffer();
		sqlStr.append(" from Tbsh32a where 1=1 and settleNo ='"+settleNo+"' and compId='"+AppUtils.getCompId()+"' ");
		List list= this.query(sqlStr.toString());
		return list;
	}
