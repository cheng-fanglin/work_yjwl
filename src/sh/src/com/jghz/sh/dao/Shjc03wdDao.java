...
@Repository
public class Shjc03wdDao extends BaseDao {
	
	public void pagingQuery03 (Page<Tbwd03> page, Map<String, Object> paramater)
			throws Exception {
		String hql = " from "+Tbwd03.class.getName()+ " where 1=1 ";
		if (paramater != null) {
