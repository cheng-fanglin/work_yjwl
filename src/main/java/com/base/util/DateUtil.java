 ...
 * 类描述：   日期工具类
 * 创建人：lichangyu   
 * 创建时间：2014-12-1 上午10:55:12   
 * 修改人：   
 * 修改时间：2014-12-1 上午10:55:12   
 * 修改备注：   
 * @version    
 *
 */
public class DateUtil {
	...
	public static String  getBeforeDateOfMonth(Date date)
	{
	...
	public static int getYearsDiff(Date date1,Date date2)
	{
		...
		int daysDiff =(int) Math.abs((c1.getTimeInMillis()-c2.getTimeInMillis()) / (24 * 3600 * 1000));
	...
	/**
	 * 计算目标时间距离当前时间的天数，小时数，分钟数，秒数
	 * @date 2014-12-26 上午10:53:35
	 * @author lulu
	 * @param now
	 * @param comDate
	 * @return Object[0:天数;1:小时数;2:分钟数;3:秒数;]
	 */
	public static Object[] countYHMS(Date now,Date comDate){
		long l=now.getTime()-comDate.getTime();
		l = Math.abs(l);
	 ...
	 */
	public static Date strFormatDate(String date,String pattern) throws ParseException {
		SimpleDateFormat sdf = new SimpleDateFormat(pattern);
