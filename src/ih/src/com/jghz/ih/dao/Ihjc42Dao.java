...
@Component
public class Ihjc42Dao extends BaseDao{
	public void pagingQuery(Page<Tbih42> page, Map<String, Object> paramater)
			throws Exception {
		String hql = " from "+Tbih42.class.getName()+ " where 1=1 ";
		//方式一:自定义Dao实现
		if (paramater != null) {	
			//合同号
