...
/**
 * tbih60a:TBIH60A(货权转授表导入备份)
 */
@Entity
@Table(name = "tbih60a")
public class Tbih60a implements Serializable {
	...
	public Tbih60a(String ih60aId, String compId, String zhd, String inNo,
			String outNo, String labelNo, String orderNo, String orderItem,
			String oldCustNo, String oldCustName, String newCustNo,
			String newCustName, String prodType, String prodTypeName,
			...
			String wareQwCode, String layerCode, String flag, String zsTime,
			String zsEmp, String lb, String ladingNo, String ladingDate,
			String jfr, String zsFlag, BigDecimal zsPrice, BigDecimal zsAmt,
			BigDecimal zsOverdueAmt, String overduePayCompNo,
			String overduePayCompName, String overdueFlag,
			String overdueSettleType, String age, String area,
			String batchFlag, String status, String by1, String by2,
			String by3, String by4, BigDecimal by5, String createEmp,
			Date createDate, String updateEmp, Date updateDate, int version) {
		super();
		this.ih60aId = ih60aId;
		this.compId = compId;
		this.zhd = zhd;
		this.inNo = inNo;
		this.outNo = outNo;
	...
	public void setIh60aId(String ih60aId) {
		this.ih60aId = ih60aId;
	}

	@Id
	@Column(name = "IH60A_ID_", length = 50, nullable = false)
	public String getIh60aId() {
		return ih60aId;
	}
	...
	public String toString() {
		return "Tbih60a [ih60aId=" + ih60aId + ",compId=" + compId + ",zhd="
				+ zhd + ",inNo=" + inNo + ",outNo=" + outNo + ",labelNo="
				+ labelNo + ",orderNo=" + orderNo + ",orderItem=" + orderItem
				+ ",oldCustNo=" + oldCustNo + ",oldCustName=" + oldCustName
				+ ",newCustNo=" + newCustNo + ",newCustName=" + newCustName
				...
				+ ",num=" + num + ",wareQwCode=" + wareQwCode + ",layerCode="
				+ layerCode + ",flag=" + flag + ",zsTime=" + zsTime + ",zsEmp="
				+ zsEmp + ",lb=" + lb + ",ladingNo=" + ladingNo
				...
				+ ",area=" + area + ",batchFlag=" + batchFlag + ",status="
				+ status + ",by1=" + by1 + ",by2=" + by2 + ",by3=" + by3
				+ ",by4=" + by4 + ",by5=" + by5 + ",createEmp=" + createEmp
