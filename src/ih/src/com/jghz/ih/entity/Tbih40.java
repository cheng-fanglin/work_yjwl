...
@Entity
@Table(name = "tbih40")
public class Tbih40 implements Serializable {
	 ...
	 * 冲红重量:冲红重量
	 */
	@PropertyDef(label = "冲红重量", description = "冲红重量:冲红重量")
	private BigDecimal chWgt;

	/**
	 * 冲红金额:冲红金额
	 */
	@PropertyDef(label = "冲红金额", description = "冲红金额:冲红金额")
	private BigDecimal chAmt;

	/**
	 * 冲红标记:冲红标记
	 */
	@PropertyDef(label = "冲红标记", description = "冲红标记:冲红标记")
	...
	public Tbih40(String ih40Id, String compId, String settleNo,
			String yearMonth, String settleType, String settleDate,
			String settleEmp, String cancleDate, String cancleEmp,
			String priceSno, String jsxm, String custNo, String custName,
			...
			BigDecimal pieceCount, BigDecimal num, BigDecimal wgt,
			BigDecimal price, BigDecimal totalAmt, BigDecimal taxAmt,
			BigDecimal jkqrtjFy, BigDecimal qrphFy, BigDecimal ts,
			BigDecimal storagePrice, BigDecimal storageAmt,
			BigDecimal liftingPrice, BigDecimal liftingAmt,
			BigDecimal tranPrice, BigDecimal tranAmt, BigDecimal discountPrice,
			BigDecimal discountAmt, BigDecimal orderPrice, BigDecimal orderAmt,
			BigDecimal premiumsAmt, BigDecimal returnPrice,
			BigDecimal returnAmt, BigDecimal turnningPrice,
			BigDecimal turnningAmt, BigDecimal overduePrice,
			BigDecimal overdueAmt, String overduePayCompNo,
			String overduePayCompName, String overdueSettleType,
			String overdueSettleNo, String overdueSettleFlag,
			String overdueSettleBill, BigDecimal managerPrice,
			BigDecimal managerAmt, String managerSettleType,
			String managerPayCompNo, String managerPayCompName,
			String managerSettleNo, String managerSettleFlag,
			String managerSettleBill, BigDecimal chWgt, BigDecimal chAmt,
			String chFlag, String outDate, String iszj, String status,
	...
	@Id
	@Column(name = "IH40_ID_", length = 50, nullable = false)
	...
	@Column(name = "SETTLE_TYPE_", length = 20, unique = true)
	...
	@Column(name = "PAY_COMP_NO_", length = 20, unique = true)
	...
	public void setChWgt(BigDecimal chWgt) {
		this.chWgt = chWgt;
	}

	@Column(name = "CH_WGT_")
	public BigDecimal getChWgt() {
		return chWgt;
	}

	public void setChAmt(BigDecimal chAmt) {
		this.chAmt = chAmt;
	}

	@Column(name = "CH_AMT_")
	public BigDecimal getChAmt() {
		return chAmt;
	}
	...
	@Column(name = "CH_FLAG_", length = 20)
	...
	public String toString() {
		return "Tbih40 [ih40Id=" + ih40Id + ",compId=" + compId + ",settleNo="
				+ settleNo + ",yearMonth=" + yearMonth + ",settleType="
				+ settleType + ",settleDate=" + settleDate + ",settleEmp="
				+ settleEmp + ",cancleDate=" + cancleDate + ",cancleEmp="
				+ cancleEmp + ",priceSno=" + priceSno + ",jsxm=" + jsxm
				+ ",custNo=" + custNo + ",custName=" + custName
				+ ",orderCompNo=" + orderCompNo + ",orderCompName="
				+ orderCompName + ",payCompNo=" + payCompNo + ",payCompName="
				+ payCompName + ",billCompNo=" + billCompNo + ",billCompName="
				+ billCompName + ",billNo=" + billNo + ",contNo=" + contNo
				+ ",orderNo=" + orderNo + ",orderItem=" + orderItem
				+ ",deliveryNo=" + deliveryNo + ",ladingNo=" + ladingNo
				+ ",outNo=" + outNo + ",tranType=" + tranType + ",pieceCount="
				+ pieceCount + ",num=" + num + ",wgt=" + wgt + ",price="
				...
				+ ",chWgt=" + chWgt + ",chAmt=" + chAmt + ",chFlag=" + chFlag
				+ ",outDate=" + outDate + ",iszj=" + iszj + ",status=" + status
				+ ",ysyf=" + ysyf + ",fno=" + fno + ",iscbjs=" + iscbjs
				+ ",syhch=" + syhch + ",shipNo=" + shipNo + ",carNo=" + carNo
